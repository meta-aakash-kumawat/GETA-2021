...
public class CalculateMass 
{
    ...
    /**
     * To get the moleculer mass of the given compound
    ...
    public int getMass(String string) 
    {
        ...
        while (index < string.length()) 
        {
            ...
            else if (currentChar == '(') 
            {
                ...
                mass += (getMass(temp) * Integer.valueOf(string.substring(dist, dist2)) + getMass(string
                                .substring(dist2)));
                index = string.length();
    ...
    /**
     * Check for the integer type
     * @param currentChar current character to be checked
