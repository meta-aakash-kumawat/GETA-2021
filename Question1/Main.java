...
public class Main 
{
	...
	public static void main(String[] args) throws Exception   
	{
        ...
        Object obj1 = new JSONParser().parse(new FileReader("C:\\Users\\aakash.kumawat_metac\\Desktop\\data.json")); 
        ...
        { 
            ...
            obj.insert(Integer.valueOf((String) pair.getKey() ), (String)pair.getValue() , obj.getRoot());
        } 
