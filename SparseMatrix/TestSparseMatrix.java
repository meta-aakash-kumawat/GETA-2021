...
public class TestSparseMatrix 
{
	...
	@Test
	public void performTransposeOfMatrix_whenSolutionExists()
	{
	...
	@Test
	public void CheckSymmetryOfMatrix_whenSolutionExists()
	{
	...
	@Test
	public void addTwoMatrices_whenSolutionExists()
	{
		int[][] temp = new int[][]{{1,0,0},{0,2,0},{0,0,1}};
	...
	@Test
	public void multiplyTwoMatrices_whenSolutionExists()
	{
		int[][] temp = new int[][]{{1,0,0},{0,2,0},{0,0,1}};
		int[][] temp1 = new int[][]{{3,0,5},{0,2,0},{0,0,1}};
		SparseMatrix obj = new SparseMatrix(temp);
